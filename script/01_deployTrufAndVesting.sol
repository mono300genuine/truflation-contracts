...
contract DeployTokenAndVesting is Script {
    ...
    function run() public {
        ...
        TrufVesting.VestingInfo memory vestInfo = TrufVesting.VestingInfo(0, 0, 1, 31536000, 3600);
        TrufVesting.VestingInfo memory vestInfo2 = TrufVesting.VestingInfo(1000, 600, 0, 31536000, 600);
